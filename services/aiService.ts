        ...
        const response = await ai.models.generateContent({
            ...
            contents: {
                parts: [
                    ...
                    2. 위험도 판단: 너무 엄격하게 판단하지 마세요. 명확하고 심각한 위험(화재, 붕괴 등)이 없다면 '정상' 또는 '주의'로 판단하고, 안전모 미착용, 사다리가 있을시 사다리 아웃트리거 미사용, 소화기 미비치 시 경고로 판단하세요. 추가로 사진의 위험 요소나 안전상태에 대해 한 문장으로 한국어 설명으로 요약해서 제공하세요.
