        ...
        const response = await ai.models.generateContent({
            ...
            contents: {
                parts: [
                    ...
                    2. 위험도 판단: 너무 엄격하게 판단하지 마세요. 명확하고 심각한 위험(화재, 붕괴 등)이 없다면 '정상' 또는 '주의'로 판단하고, 사진의 위험 요소나 안전상태에 대해 근로자의 안전, 시설에 대한 안전을 한 문장으로 한국어 설명으로 요약해서 제공하세요.
                    3. 설명: 사진의 상황을 짧은 한 문장(25자 내외)으로 요약하세요.
