        ...
        const response = await ai.models.generateContent({
            ...
            contents: {
                parts: [
                    ...
                    3. 위험도 판단시 사람이 있을 시 안전모 착용 여부, 사다리가 있을시 사다리 아웃트리거 사용 여부, 소화기 비치 여부는 반드시 파악해 공유해주고 해당 안전상태 양호하면 해당 내용에 대해 별도 언급하지 말고 해당 위험 있을시 위험도 판단은 경고로 판단하세요. 추가로 정리정돈과 장애물 대한 내용은 위험도 판단 내용에서 제외하세요.
